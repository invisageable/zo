...
The LinearAnalyzer implements Phase 1 of the zo compiler's semantic analysis pipeline. It leverages the postorder property of the Tree generated by the StackMachine parser to perform complete semantic analysis in a single linear pass.

### Key Design Principles

1. **Single Linear Pass**: Processes Tree nodes exactly once in postorder
...
- Overall: O(n) linear in Tree size
...
- Small Tree (100 nodes): <10μs
- Medium Tree (10K nodes): <500μs
- Large Tree (100K nodes): <5ms
- XLarge Tree (1M nodes): <50ms
...
- Works with postorder Tree from StackMachine parser
