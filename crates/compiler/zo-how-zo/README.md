...
EVERY FILES ACT LiKE AS A TUTORiAL. THEY ARE THERE TO HELP YOU TO UNDERSTAND THE ADVANTAGE OF USiNG zo. WHAT WE BRiNG TO THE TABLE TO SHiNE FROM OTHER LANGUAGE AND STAY UNiQUE. READ THESE FiLES iN ORDER — EACH PROGRAM CAN BE `build` WiTH THE FOLLOWiNG COMMAND:
