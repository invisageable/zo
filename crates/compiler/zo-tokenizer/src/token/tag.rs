...
type AtomTagNames = HashMap<SmolStr, Atom>;
type MathMlTagNames = HashMap<SmolStr, MathMl>;
type SvgTagNames = HashMap<SmolStr, Svg>;
type CustomTagNames = HashMap<SmolStr, Custom>;
...
lazy_static::lazy_static! {
  ...
  pub static ref ATOM_TAG_NAMES: AtomTagNames = HashMap::from([
    (SmolStr::new_inline(":bin"), Atom::Bind),
    (SmolStr::new_inline(":else"), Atom::Else),
    (SmolStr::new_inline(":for"), Atom::For),
    (SmolStr::new_inline(":if"), Atom::If),
    (SmolStr::new_inline(":?"), Atom::Question),
    (SmolStr::new_inline(":while"), Atom::While),
    (SmolStr::new_inline(":"), Atom::Wildcard),
  ]);
}
...
lazy_static::lazy_static! {
  ...
  pub static ref MATHML_TAG_NAMES: MathMlTagNames = HashMap::from([
    (SmolStr::new_inline("math"), MathMl::Math),
  ]);
}
...
lazy_static::lazy_static! {
  ...
  pub static ref SVG_TAG_NAMES: SvgTagNames = HashMap::from([
    (SmolStr::new_inline("a"), Svg::A),
    (SmolStr::new_inline("svg"), Svg::Svg),
  ]);
}
...
lazy_static::lazy_static! {
  ...
  pub static ref CUSTOM_TAG_NAMES: CustomTagNames = HashMap::from([
    (SmolStr::new_inline("_"), Custom::Fragment),
  ]);
}
