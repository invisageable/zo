...
THiS DOCUMENT CONTAiNS ALL MY REFERENCES TO BE ABLE TO BUiLD zo.

## language design.

  - **ECMAScript for XML(E4X) Specification**
  - https://www-archive.mozilla.org/js/language/ECMA-357.pdf — ECMA International (2004)
...
- **A modular module system**
  - https://xavierleroy.org/publi/modular-modules-jfp.pdf — Xavier Leroy (1996)

## pretty printer.

- **A pretty printer**
  - https://homepages.inf.ed.ac.uk/wadler/papers/prettier/prettier.pdf — Philip Wadler (1995)
  
- **Strictly Pretty**
- https://www.researchgate.net/publication/2629249_Strictly_Pretty — Christian Lindig (2000)
